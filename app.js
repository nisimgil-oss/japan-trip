...
(function () {
  ...
  const TRAINS = [
    ...
    { id: 't-romancecar', date: '2026-09-22', salesOpen: '2026-08-22', from: 'Shinjuku', to: 'Hakone-Yumoto', url: 'https://www.web-odakyu.com/e-romancecar/?language=en',
      urgent: { he: '🚨 הכי דחוף! נפתח 22.8 ב-10:00 יפן (04:00 בישראל) · Silver Week — נחטף בדקות. תעמידו אזעקה!', es: '🚨 ¡El más urgente! Abre 22/8 a las 10:00 Japón (04:00 Argentina) · Silver Week — se agota en minutos. ¡Poné alarma!' },
  ...
  const EVENTS = [
    ...
    { id: 'e-teamlab', date: '2026-09-30', salesOpen: '2026-08-01', url: 'https://www.teamlab.art/e/planets/',
      title: { he: "🌀 teamLab Planets (Toyosu)", es: "🌀 teamLab Planets (Toyosu)" },
      note: { he: "הועבר ל-30.9 בערב · כרטיס עם שעת כניסה — הזמינו סלוט ~17:30 מראש.", es: "Movido al 30/9 a la noche · entrada con horario — reservá el slot ~17:30 con anticipación." } },
  ...
  const DEFAULT_CHECK = {
    he: {
      'הזמנות דחופות (עכשיו!)': [
        ...
        'teamLab Planets (30.9 בערב), חוויית מאיקו, סדנת תה+קימונו, סדנת סושי',
    ...
    es: {
      'Reservas urgentes (¡ya!)': [
        ...
        'teamLab Planets (30/9 a la noche), experiencia maiko, taller de té+kimono, clase de sushi',
