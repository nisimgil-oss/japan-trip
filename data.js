 ...
 "he": {
  ...
  "routes": [
   ...
   },
   {
    ...
    "area": "האקונה",
    "emoji": "♨️",
    "title": "האקונה — מוזיאון בשמיים הפתוחים ועיירת האונסן",
    "subtitle": "יום הגעה רגוע · רכבת הרים, פסלים ואמבט רגליים · 10:15–15:00",
    "intro": "יום מעבר רגוע: הרומנסקאר מגיע ל-Hakone-Yumoto ב-10:15, וממנו רכבת ההרים העתיקה מטפסת אל מוזיאון הפסלים בשמיים הפתוחים — אמנות עולמית על מדשאות מול ההרים, עם אמבט רגליים חם. חוזרים לעיירת האונסן, טועמים ומטיילים, ונכנסים לרייוקאן אחה״צ לאמבט פרטי וקייסקי. ה-Hakone Free Pass מכסה את כל התחבורה.",
    "meta": {
     "duration": "~4 שעות (חצי יום)",
     "distance": "קצר — 2 נסיעות רכבת + הליכות במוזיאון ובעיירה",
     "start": "תחנת Hakone-Yumoto — מעבר לרכבת ההרים Tozan",
     "getThere": "רומנסקאר 9:00→10:15 (נסגר, מושב 6D). Hakone Free Pass מכסה Tozan/כבלית/רכבל/שייט/אוטובוס",
     "end": "צ׳ק-אין ב-Yaeikan ביומוטו (~15:00) — אונסן פרטי (kashikiri) וקייסקי"
    },
    "stops": [
     { "time": "10:25", "name": "רכבת ההרים Tozan — הזיגזג אל Chokoku-no-Mori", "walk": "מעבר בתוך תחנת Yumoto", "see": "רכבת הרים ל-3 קרונות שמטפסת ~40 דק׳ אל תחנת Chokoku-no-Mori (לפני Gora). כרטיס ב-Free Pass.", "why": "רכבת ההרים העתיקה ביפן. כדי לעלות שיפוע תלול היא עושה 3 סוויצ׳בקים — הנהג והכרטיסן מחליפים קצה בכל אחד. חוויה בפני עצמה.", "tip": "יוצאת כל 15–20 דק׳. שבו בצד ימין בעלייה לנוף העמק.", "map": "35.2325,139.1055" },
     { "time": "11:15", "name": "מוזיאון הפסלים בשמיים הפתוחים (彫刻の森)", "walk": "~2 דק׳ מהתחנה", "see": "לולאת גן הפסלים על 70,000 מ״ר דשא — Moore, Bourdelle, Miró — מול הרי האקונה. פתוח 9:00–17:00, ~¥2,000 (הנחה עם Free Pass).", "why": "המוזיאון החיצוני הראשון ביפן (1969) — אמנות מודרנית, הרים ואמבט אונסן במקום אחד.", "tip": "הראו את ה-Free Pass בקופה להנחה. לולאת הגן קלה ורובה שטוחה.", "map": "35.2445,139.0517" },
     { "time": "11:45", "name": "מגדל הזכוכית 'סימפוניה' (Symphonic Sculpture)", "walk": "בתוך המתחם", "see": "מגדל ויטראז׳ של Gabriel Loire — עולים במדרגות הלוליין פנימה לקירות זכוכית זוהרים ותצפית מלמעלה.", "why": "הנקודה הכי מצולמת במוזיאון — אור צבעוני שוטף מכל עבר.", "tip": "עלו עד הראש לנוף על כל הגן וההרים.", "map": "35.2445,139.0517" },
     { "time": "12:15", "name": "ביתן פיקאסו (Picasso Pavilion)", "walk": "בתוך המתחם", "see": "גלריה מקורה עם 300+ עבודות פיקאסו — בעיקר קרמיקה, וגם ציור והדפס.", "why": "אוסף פיקאסו נדיר, מביא את הטיול פנימה בין הפסלים שבחוץ.", "tip": "מנוחה ממוזגת אחרי הגן הפתוח.", "map": "35.2445,139.0517" },
     { "time": "12:45", "name": "אמבט הרגליים (ashiyu) — חינם עם הכניסה", "walk": "ליד בית הקפה", "see": "אמבט רגליים חם ממעיין טבעי — הרגע המרגיע לסיום הביקור.", "why": "אמנות + הרים + אונסן — בדיוק מה שהאקונה מבטיחה, בחינם עם הכרטיס.", "tip": "הביאו מגבת קטנה (חנות המוזיאון מוכרת מגבת אמבט ייעודית).", "map": "35.2445,139.0517" },
     { "time": "13:45", "name": "רחוב הקניות של Hakone-Yumoto + onsen-manju", "walk": "מהתחנה, רחוב ראשי ~400 מ׳", "see": "דוכני מתוקים וחטיפים: onsen-manju חם (Marushima הוותיק), סנבי צרוב ביד, קמאבוקו מטוגן, טירמיסו-סופט.", "why": "יומוטו הוא שער האונסן של האקונה — מעיין חם פעיל מ-738 לספירה, ~1,200 שנה.", "tip": "אכלו manju חם על המקום. מזומן לדוכנים הקטנים.", "map": "35.2323,139.1050" },
     { "time": "14:15", "name": "גשר Ajisai ונהר Hayakawa", "walk": "ליד התחנה", "see": "גשר הולכי רגל אדום מעל נהר Hayakawa; רדו אל שפת המים לנוף שקט. אם רעבים — סובה ג׳ואארי מפורסמת ב-Hatsuhana.", "why": "רגע נהר שליו הרחק מהדוכנים; Hatsuhana היא סובה 100% כוסמת בת ~90 שנה.", "tip": "Hatsuhana עמוסה בצהריים — בואו מוקדם או אחרי 14:00. חזרו לצ׳ק-אין ~15:00.", "map": "35.2330,139.1040" }
    ],
    "special": [
     "🦶 אמבט הרגליים במוזיאון — מעיין חם טבעי, חינם עם הכרטיס. הביאו מגבת.",
     "🚃 רכבת ה-Tozan עם 3 הסוויצ׳בקים — הנהג מחליף קצה בכל תפנית, רכבת ההרים העתיקה ביפן.",
     "🍡 שורת ה-onsen-manju מול התחנה (Marushima, Kikukawa) — אכלו אחד חם ומאודה במקום.",
     "🎫 ה-Hakone Free Pass (יומיים) מכסה את הכול; היום צריך רק את רכבת Tozan, אבל הפס פתוח להמשך."
    ]
   },
   {
    "id": "magome",
   ...
   },
   {
    ...
    "stops": [
     ...
     { "time": "08:05", "name": "Zuigudo — מנהרת הרחם (胎内めぐり)", "walk": "בתוך מתחם קיומיזו", "see": "מעבר תת-קרקעי חשוך לגמרי (¥100, נעליים בחוץ) — ממששים קיר של חרוזי תפילה עד 'אבן משאלה' מוארת, מסובבים ומאחלים.", "why": "טקס 'לידה מחדש' חושי ומדיטטיבי נדיר, ומפתיע.", "tip": "עשו בדרך פנימה. אמתו שפועל ב-2026 (שעות לא סדירות).", "map": "34.9950,135.7846" },
 ...
 "es": {
  ...
  "routes": [
   ...
   },
   {
    ...
    "area": "Hakone",
    "emoji": "♨️",
    "title": "Hakone — Museo al Aire Libre y el pueblo de aguas termales",
    "subtitle": "Día de llegada tranquilo · tren de montaña, esculturas y baño de pies · 10:15–15:00",
    "intro": "Un día de traslado relajado: el Romancecar llega a Hakone-Yumoto a las 10:15, y de ahí el viejo tren de montaña trepa hasta el Museo al Aire Libre — arte mundial sobre el césped frente a las montañas, con un baño de pies caliente. Se vuelve al pueblo termal, se prueba y se pasea, y a la tarde se entra al ryokan para el baño privado y el kaiseki. El Hakone Free Pass cubre todo el transporte.",
    "meta": {
     "duration": "~4 horas (medio día)",
     "distance": "Corto — 2 viajes en tren + caminatas en el museo y el pueblo",
     "start": "Estación Hakone-Yumoto — transbordo al tren de montaña Tozan",
     "getThere": "Romancecar 9:00→10:15 (reservado, asiento 6D). El Hakone Free Pass cubre Tozan/funicular/teleférico/barco/bus",
     "end": "Check-in en Yaeikan en Yumoto (~15:00) — onsen privado (kashikiri) y kaiseki"
    },
    "stops": [
     { "time": "10:25", "name": "Tren de montaña Tozan — el zigzag a Chokoku-no-Mori", "walk": "Transbordo dentro de la estación Yumoto", "see": "Tren de montaña de 3 vagones que trepa ~40 min hasta la estación Chokoku-no-Mori (antes de Gora). Cubierto por el Free Pass.", "why": "El tren de montaña más antiguo de Japón. Para subir la pendiente hace 3 switchbacks — el conductor y el guarda cambian de punta en cada uno. Una experiencia en sí.", "tip": "Sale cada 15–20 min. Sentate a la derecha subiendo para la vista del valle.", "map": "35.2325,139.1055" },
     { "time": "11:15", "name": "Museo al Aire Libre (彫刻の森)", "walk": "~2 min de la estación", "see": "Circuito del jardín de esculturas sobre 70.000 m² de césped — Moore, Bourdelle, Miró — frente a las montañas de Hakone. Abierto 9:00–17:00, ~¥2.000 (descuento con Free Pass).", "why": "El primer museo al aire libre de Japón (1969) — arte moderno, montañas y baño de onsen en un solo lugar.", "tip": "Mostrá el Free Pass en la boletería para el descuento. El circuito del jardín es fácil y casi plano.", "map": "35.2445,139.0517" },
     { "time": "11:45", "name": "Torre de vidrio 'Symphonic Sculpture'", "walk": "Dentro del predio", "see": "Torre de vitral de Gabriel Loire — subís por la escalera caracol interior entre paredes de vidrio que brillan, con vista desde arriba.", "why": "El punto más fotogénico del museo — luz de colores que baña todo.", "tip": "Subí hasta la cima para la vista de todo el jardín y las montañas.", "map": "35.2445,139.0517" },
     { "time": "12:15", "name": "Pabellón Picasso", "walk": "Dentro del predio", "see": "Galería techada con 300+ obras de Picasso — sobre todo cerámica, y también pintura y grabado.", "why": "Una colección rara de Picasso, que trae el paseo adentro tras las esculturas de afuera.", "tip": "Un descanso con aire acondicionado después del jardín abierto.", "map": "35.2445,139.0517" },
     { "time": "12:45", "name": "Baño de pies (ashiyu) — gratis con la entrada", "walk": "Junto al café", "see": "Baño de pies caliente de manantial natural — el momento relajante para cerrar la visita.", "why": "Arte + montañas + onsen — justo lo que promete Hakone, gratis con la entrada.", "tip": "Llevá una toalla chica (la tienda del museo vende una toalla de baño de pies propia).", "map": "35.2445,139.0517" },
     { "time": "13:45", "name": "Calle comercial de Hakone-Yumoto + onsen-manju", "walk": "Desde la estación, calle principal ~400 m", "see": "Puestos de dulces y snacks: onsen-manju caliente (Marushima, el histórico), senbei tostado a mano, kamaboko frito, soft de tiramisú.", "why": "Yumoto es la puerta termal de Hakone — manantial activo desde el 738, ~1.200 años.", "tip": "Comé el manju caliente en el lugar. Efectivo para los puestos chicos.", "map": "35.2323,139.1050" },
     { "time": "14:15", "name": "Puente Ajisai y río Hayakawa", "walk": "Junto a la estación", "see": "Puente peatonal rojo sobre el río Hayakawa; bajá a la orilla para una vista tranquila. Si tienen hambre — la famosa soba juwari de Hatsuhana.", "why": "Un momento de río sereno lejos de los puestos; Hatsuhana es soba 100% trigo sarraceno con ~90 años.", "tip": "Hatsuhana se llena al mediodía — vayan temprano o después de las 14:00. Vuelvan al check-in ~15:00.", "map": "35.2330,139.1040" }
    ],
    "special": [
     "🦶 El baño de pies del museo — manantial caliente natural, gratis con la entrada. Llevá toalla.",
     "🚃 El tren Tozan con sus 3 switchbacks — el conductor cambia de punta en cada giro, el tren de montaña más antiguo de Japón.",
     "🍡 La fila de onsen-manju frente a la estación (Marushima, Kikukawa) — comé uno caliente al vapor en el lugar.",
     "🎫 El Hakone Free Pass (2 días) cubre todo; hoy solo usan el tren Tozan, pero el pase queda abierto para seguir."
    ]
   },
   {
    "id": "magome",
   ...
   },
   {
    ...
    "stops": [
     ...
     { "time": "08:05", "name": "Zuigudo — el túnel del vientre (胎内めぐり)", "walk": "Dentro del predio de Kiyomizu", "see": "Pasaje subterráneo totalmente a oscuras (¥100, zapatos afuera) — palpás una pared de cuentas de oración hasta una 'piedra de deseos' apenas iluminada, la girás y pedís.", "why": "Un raro ritual sensorial y meditativo de 'renacimiento', y sorprendente.", "tip": "Hacelo al entrar. Verificá que funcione en 2026 (horarios irregulares).", "map": "34.9950,135.7846" },
