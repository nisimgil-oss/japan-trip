   ...
   },
   {
    ...
    "events": [
     ...
     },
     {
      ...
      "type": "sightseeing",
      "area": "Tsumago",
      "title": "צומאגו — כפר אֶדו שעצר את השעון",
      "desc": "עיירת דואר משומרת בלי חוטי-חשמל ובלי מכוניות — סמטאות עץ, פנסים וחנויות מלאכה.",
   ...
   },
   {
    ...
    "events": [
     ...
     },
     {
      ...
      "type": "sightseeing",
      "area": "Tsumago",
      "title": "Tsumago — la aldea Edo que detuvo el tiempo",
      "desc": "Pueblo de postas preservado, sin cables ni autos — callecitas de madera, faroles y artesanías.",
