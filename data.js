    ...
    "events": [
     {
      ...
      "type": "transport",
      "area": "Tokyo",
      "title": "שליחת מזוודות ותחילת הדרך",
      "desc": "שלחו את המזוודות הגדולות בשירות הטאקיוּבין ישירות למלון בקיוטו — הן יחכו לכם שם מחר. אתם נוסעים עכשיו רק עם תיקי לילה קלים.",
     ...
     },
     {
      ...
      "type": "sightseeing",
      "area": "Hakone",
      "title": "טעימת הקונה — מוזיאון ואגם",
      "desc": "אם הזמן מאפשר, עצרו ב-Hakone Open-Air Museum — פסלים מפורסמים בטבע פתוח ועמק הרים. חלופה: צפייה קצרה באגם Ashi לפני הגעה לרייוקאן.",
    ...
    "events": [
     {
      ...
      "type": "food",
      "area": "Tsumago",
      "title": "ארוחת בוקר בפונדק מגומה",
      "desc": "מתחילים את יום ההולדת בארוחת בוקר יפנית מסורתית בפונדק שבמגומה — אורז, מרק מיסו, דגיגים מיובשים ופשטידות ירק. אווירה רגועה לפני הצעידה הגדולה.",
      "tips": "הספיקו לאכול היטב — הנקאסנדו אינו ספרינט. בקשו ממנהל הפונדק לאשר שירות שינוע המזוודות לפני שצאתם.",
      "cost": "כלול בלינה",
      "booking": ""
     },
     {
      ...
      "title": "הנקאסנדו — מגומה עד צומאגו",
      "desc": "שמונה קילומטרים של שביל אבן מן תקופת אדו שעוברים ביער ברוש, ממלאות מים, מפלים ובית תה עם שתייה חינם שמחכה לכם בדרך. צלצלו בפעמוני הדובים ושאפו את האוויר הירוק — זה שביל שנעשה בדיוק בשביל יום כזה.",
      "tips": "שלחו את המזוודות קדימה דרך שירות שינוע המטען — תלכו קלים וחופשיים. נעלי הליכה ומים הם חובה; הצל ביער מפצה על העליות.",
      "cost": "חינם (שביל פתוח)",
      "booking": "השתמשו בשירות שינוע המזוודות מגומה↔צומאגו (הפקדה בבוקר מוקדם בפונדק)",
      "highlight": true
     },
     {
      "start": "12:00",
      ...
      "type": "food",
      "area": "Tsumago",
      "title": "צהריים — סובה כוסמת בצומאגו",
      "desc": "מגיעים לצומאגו עם תיאבון שהורוויח: קערת סובה כוסמת מקומית מוגשת קרה או חמה, טבולה ברוטב דאשי עמוק. מנוחה קצרה לרגליים לפני גילוי הכפר.",
      "tips": "מסעדות הסובה בכניסה לכפר מתמלאות מהר — היכנסו במוקדם יחסית. פודינג טופו כמנת פתיחה הוא גן עדן.",
      "cost": "¥1,000–1,800 לאדם",
      "booking": ""
     },
     {
      ...
      "type": "sightseeing",
      "area": "Tsumago",
      "title": "גילוי צומאגו — כפר אדו שעצר את השעון",
      "desc": "צומאגו היא פלא: רחוב ראשי ללא מכוניות, ללא עמודי חשמל, ללא עידן מודרני — רק בתי עץ ואבן שנשמרו מתקופת אדו. פנסי בית, חנויות אומנות, מוזיאון הדואר הישן של המוס — כל פינה מספרת סיפור.",
      "tips": "כניסה למוזיאוני הכפר המשולבת עולה ¥600 בלבד — שווה כל ין. קנו ממתק נגינו-אן של הכפר כמזכרת קטנה.",
      "cost": "¥600 (כרטיס מוזיאונים משולב) לאדם",
      "booking": "",
      "highlight": true
     },
     {
      ...
      "type": "onsen",
      "area": "Tsumago",
      "title": "אמבט יפני ורגע מנוחה ביוקאטה",
      "desc": "הגעתם לריוקן — שלכם לשעות הבאות. אמבט יפני מסורתי (בישוזן) מחכה לכם, ואחריו יוקאטה רכה ואווירת שקט שרק כפר הרים יכול לתת. רגעים כאלה לא קונים.",
      "tips": "אם הריוקן מציע אמבט פרטי — הזמינו אותו לצהריים/ערב מוקדם; זמן זוגי אידיאלי. הרפו לחלוטין לפני הערב המיוחד.",
      "cost": "כלול בלינה",
      "booking": ""
     },
     {
      ...
      "type": "birthday",
      "area": "Tsumago",
      "title": "ארוחת קייסקי ליום הולדת 40",
      "desc": "ערב שיא: קייסקי מסורתי בן שבעה מנות מוגש בחדר עם ריצפת טאטאמי, פנסים ונרות. בשלים, דגים עונתיים, טופו עם לב, ויפנית עוף בצלחת עץ לאקה — חגיגה של טעמים ורגעים שלא יחזרו. שנה אחת ביובל — ראויה לחגיגה כזאת.",
      "tips": "ציינו את יום ההולדת בהזמנה — ריוקנים רבים מכינים הפתעה קטנה. שתו סאקה מקומי ולחו לחיים.",
      "cost": "¥12,000–20,000 לאדם (כלול בלינה ברוב הריוקנים)",
      "booking": "הזמינו ריוקן מיוחד עם ארוחת ערב בצומאגו ומנו יום הולדת בהזמנה",
      "highlight": true
     },
     {
      "start": "21:00",
      ...
      "type": "sightseeing",
      "area": "Tsumago",
      "title": "הליכת לילה בצומאגו לאור פנסים",
      "desc": "כשהיום-טיילנים עוזבים, הכפר הוא שלכם בלבד. פנסי עץ מדליקים את הרחוב הישן, השקט מוחלט, והאוויר נקי ורענן. הרגע הזה — שניים, לילה, כפר אדו — הוא מתנה אמיתית.",
      "tips": "קחו ז'קט — הלילה בהרי נגאנו קריר אפילו בספטמבר. לכו לאט, עצרו, הקשיבו לשקט.",
      "cost": "חינם",
      "booking": "",
      "highlight": true
     }
   ...
   },
   {
    ...
    "events": [
     ...
     },
     {
      ...
      "type": "experience",
      "area": "Kyoto (Gion)",
      "title": "סדנת טקס תה וקימונו — גיון",
      "desc": "ניסיון משותף אמיתי: לובשים קימונו יחד, לומדים את תנועות טקס התה המסורתי מתוצרת מאת'ה בסגנון \"אורו\", ויוצרים מרחב אינטימי ומכוון עם האדם שאוהבים. הסדנאות בגיון עשויות לכלול גם שיעור קליגרפיה קצר — תלוי בחבילה שתבחרו.",
      "tips": "הזמינו מראש חבילה לזוג; חלק מהמקומות מציעים צילום מקצועי כתוסף. בדקו שהסדנה מתנהלת גם באנגלית.",
      "cost": "¥5,000–10,000 לאדם",
      "booking": "הזמינו מראש את הסשן של טקס התה + קימונו",
      "highlight": true
     },
     {
      "start": "17:00",
      ...
      "desc": "אחת החוויות הנדירות והמרגשות ביותר בקיוטו: ישיבה מסורתית עם מאיקו אמיתית (גיישה בשלבי הכשרה) או גייקו (מלאת-מקצוע), שמבצעת ריקוד, מנגנת שמיסן, ומשחקת איתכם משחקי אוזשיקי מסורתיים לצד כוסות סאקה. זו חלון אל עולם סגור ועתיק.",
      ...
      "booking": "הזמינו את חוויית המאיקו/גייקו הרבה מראש",
      "highlight": true
     },
     {
      "start": "19:30",
   ...
   },
   {
    ...
    "events": [
     ...
     },
     {
      ...
      "desc": "שכונת הסוחרים הישנה שמורה להפליא — בתים צרים בסגנון מאצ'יה, חנויות אריגה וקרמיקה ידנית וחצרות שקטות. תנו לרגליים להוביל, להיאבד ולגלות.",
    ...
    "events": [
     {
      ...
      "cost": "¥1,000 לאדם",
      "booking": "כרטיסים נגמרים רגע — רוכשים ב-10 לחודש הקודם דרך Lawson",
      "highlight": true
     },
     {
      "start": "13:00",
    ...
    "events": [
     {
      ...
      "type": "transport",
      "area": "Tokyo",
      "title": "Envío de equipaje y partida liviana",
      "desc": "Mandá las valijas grandes por takkyubin directo al hotel de Kyoto — van a estar esperándote mañana. Vos viajás ahora solo con una bolsa de mano liviana.",
     ...
     },
     {
      ...
      "type": "sightseeing",
      "area": "Hakone",
      "title": "Probada de Hakone — museo y lago",
      "desc": "Si el tiempo lo permite, parate en el Hakone Open-Air Museum — esculturas famosas en plena naturaleza con el valle de fondo. Alternativa: una mirada rápida al lago Ashi antes de llegar al ryokan.",
    ...
    "events": [
     {
      ...
      "type": "food",
      "area": "Tsumago",
      "title": "Desayuno en el alojamiento de Magome",
      "desc": "El día empieza con un desayuno japonés clásico en el alojamiento de Magome: arroz, sopa de miso, pescadito seco y tortillas de verdura. Una mañana tranquila antes de ponerse las botas.",
      "tips": "Comé bien — el Nakasendo no es un paseo corto. Confirmá con el staff que el servicio de reenvío de equipaje esté arreglado antes de salir.",
      "cost": "Incluido en el alojamiento",
      "booking": ""
     },
     {
      ...
      "type": "experience",
      "area": "Nakasendo Trail (Magome->Tsumago)",
      "title": "Nakasendo — De Magome a Tsumago",
      "desc": "Ocho kilómetros de adoquines de la era Edo que atraviesan bosques de ciprés, cascadas y una casa de té con bebida gratis esperándolos en el camino. Hacé sonar las campanas anti-oso y respirá hondo — este sendero fue hecho para un día como este.",
      "tips": "Mandá las valijas adelante con el servicio de equipaje Magome↔Tsumago para caminar libres y livianos. Llevá calzado de trekking y agua; la sombra del bosque compensa las subidas.",
      "cost": "Gratis (sendero público)",
      "booking": "Usá el servicio de reenvío de equipaje Magome↔Tsumago (dejarlo en el alojamiento a primera hora de la mañana)",
      "highlight": true
     },
     {
      "start": "12:00",
      ...
      "type": "food",
      "area": "Tsumago",
      "title": "Almuerzo — Soba de trigo sarraceno en Tsumago",
      "desc": "Llegás a Tsumago con hambre bien ganada: un tazón de soba de trigo sarraceno local, frío o caliente, con un caldo dashi profundo. Un descanso merecido para las piernas antes de explorar el pueblo.",
      "tips": "Los restaurantes de soba cerca de la entrada al pueblo se llenan rápido — entrá apenas llegues. El tofu frío de entrada es una delicia que no te podés perder.",
      "cost": "¥1.000–1.800 por persona",
      "booking": ""
     },
     {
      ...
      "type": "sightseeing",
      "area": "Tsumago",
      "title": "Explorando Tsumago — El pueblo Edo que paró el tiempo",
      "desc": "Tsumago es un milagro: calle principal sin autos, sin postes de luz, sin nada del siglo XXI — solo casas de madera y piedra conservadas desde la era Edo. Faroles de madera, tiendas de artesanía y el antiguo museo postal te van a llevar 300 años atrás.",
      "tips": "La entrada combinada a los museos del pueblo cuesta solo ¥600 — vale cada yen. Llevate un dulce nagino-an del pueblo como recuerdo chiquito pero auténtico.",
      "cost": "¥600 (entrada combinada museos) por persona",
      "booking": "",
      "highlight": true
     },
     {
      ...
      "type": "onsen",
      "area": "Tsumago",
      "title": "Baño japonés y descanso en yukata",
      "desc": "Llegaron al ryokan — y por las próximas horas es todo de ustedes. Un baño japonés tradicional (furo) los espera, y después yukata suave y silencio de montaña. Hay momentos que no se compran.",
      "tips": "Si el ryokan tiene baño privado, reservalo para esta tarde — ideal para estar juntos y relajados antes de la cena especial. Desconectate por completo.",
      "cost": "Incluido en el alojamiento",
      "booking": ""
     },
     {
      ...
      "type": "birthday",
      "area": "Tsumago",
      "title": "Cena kaiseki de cumpleaños 40",
      "desc": "La noche cumbre: un kaiseki tradicional de siete pasos servido en una habitación de tatami, con farolitos y velas. Sashimi estacional, tofu de corazón, pollo en laca de madera y sake local — una celebración de sabores para cuatro décadas de vida bien vividas.",
      "tips": "Mencioná el cumpleaños al reservar — muchos ryokans preparan una sorpresita especial. Brindate con sake local y festejá en grande.",
      "cost": "¥12.000–20.000 por persona (incluido en el paquete del ryokan en la mayoría de los casos)",
      "booking": "Reservá un ryokan especial con cena en Tsumago e indicá que es cumpleaños de 40 al reservar",
      "highlight": true
     },
     {
      "start": "21:00",
      ...
      "type": "sightseeing",
      "area": "Tsumago",
      "title": "Caminata nocturna por Tsumago bajo los farolitos",
      "desc": "Cuando los turistas del día se van, el pueblo es solo de ustedes. Los faroles de madera iluminan la calle histórica, el silencio es absoluto y el aire de las montañas de Nagano es puro y fresco. Este momento — dos personas, una noche, un pueblo Edo — es un regalo de verdad.",
      "tips": "Llevá una campera — las noches en las montañas de Nagano son frescas incluso en septiembre. Caminá despacio, pará seguido, escuchá el silencio.",
      "cost": "Gratis",
      "booking": "",
      "highlight": true
     }
   ...
   },
   {
    ...
    "events": [
     ...
     },
     {
      ...
      "type": "experience",
      "area": "Kyoto (Gion)",
      "title": "Ceremonia del té y kimono — Gion",
      "desc": "Una experiencia genuinamente compartida: se visten juntos con kimono, aprenden los gestos de la ceremonia del té matcha al estilo \"ura\", y crean un momento íntimo y presente el uno con el otro. Muchos talleres en Gion incluyen también una breve práctica de caligrafía — dependiendo del paquete que elijan.",
      ...
      "booking": "Reservá con anticipación la sesión de ceremonia del té + kimono",
      "highlight": true
     },
     {
      "start": "17:00",
      ...
      "desc": "Una de las vivencias más raras y memorables de Kioto: una velada íntima con una Maiko auténtica (geisha en formación) o Geiko (maestra del arte), que baila, toca el shamisen y juega con vos a los juegos tradicionales de ozashiki mientras comparten sake. Es una ventana a un mundo cerrado y milenario.",
      ...
      "booking": "Reservá la experiencia Maiko/Geiko con bastante anticipación",
      "highlight": true
     },
     {
      "start": "19:30",
   ...
   },
   {
    ...
    "events": [
     ...
     },
     {
      ...
      "desc": "El barrio antiguo de comerciantes está increíblemente preservado — casas angostas estilo machiya, tiendas de tejidos y cerámica artesanal, patios tranquilos. Dejen que los pies los lleven sin apuro, que se pierdan y descubran.",
    ...
    "events": [
     {
      ...
      "booking": "Las entradas se agotan en minutos — comprá el día 10 del mes anterior por Lawson",
      "highlight": true
     },
     {
      "start": "13:00",
